...
import { App, ShopifyToken } from '../../src/models'
const puppeteer = require('puppeteer')

const TEST_APP = null
const TEST_SHOP = 'b2b-portal-automated-test'

test('When merchant installs app, the installation of the app is successful', async t => {
  /*
